...
export async function POST(req: Request) {
  ...
  try {
    ...
    console.error(JSON.stringify({ level: "error", event: "telemetry.rate_limit.failed", surface: "admin_panel", error: error instanceof Error ? error.message : String(error) }));
