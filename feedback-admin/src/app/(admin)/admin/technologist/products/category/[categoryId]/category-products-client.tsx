...
export function CategoryProducts({ categoryId, products, total, page, search }: { categoryId: string; products: CatalogProduct[]; total: number; page: number; search: string }) {
