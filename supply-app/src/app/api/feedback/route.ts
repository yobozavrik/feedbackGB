...
// / замовлення сировини / брак сировини live in zakupki.requests (see
// /api/supply/raw-materials/order and /defect) — one history across every
// workshop/store/warehouse, not the feedback table.
